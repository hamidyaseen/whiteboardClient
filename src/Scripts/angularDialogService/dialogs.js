...
angular.module('dialogs.main',['dialogs.services','ngSanitize']) // requires angular-sanitize.min.js (ngSanitize) //code.angularjs.org/1.2.1/angular-sanitize.min.js
	...
	.run(['$templateCache','$interpolate',function($templateCache,$interpolate){
    	...
    	$templateCache.put('/dialogs/error.html', '<div class="modal-header dialog-header-error"><h4 class="modal-title font-desc-lg vw-color"><span ng-bind-html="header"></span></h4></div><div class="modal-body font-desc-md vw-color" ng-bind-html="msg"></div><div class="modal-footer"><button type="button" class="btn btn-default" id="CancelBtn" ng-click="cancel()" ng-show="false">Cancel</button><button type="button" class="btn btn-default" ng-click="close()">' + startSym + '"DIALOGS_CLOSE" | translate' + endSym + '</button></div>');
